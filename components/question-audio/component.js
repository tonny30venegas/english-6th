...
const selectionQuestion = ({ nextQuestion, question, setScore }) => {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.questionContainer}>
          <Text style={styles.instruction}>Listen to the audio and select the word pronounced. </Text>
        </View>
        
        <View style={styles.answerContainer}>
            <Ionicons style={styles.question} name="md-play-circle" color={iconColor} onPress={speak} />
            <Separator />
            <TouchableOpacity
                activeOpacity={0.6}
